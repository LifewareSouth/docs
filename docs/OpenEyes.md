...
1. [Estado inicial del programa](#_Toc57049453)

2. [OpenEyes – Funciones del menú principal](#_Toc57049454)

    [2.1. Letras](#_Toc57049455)

    - [1.1. Funciones de sección letras](#_Toc57049456)

        - [1. Agregar al diccionario](#_Toc57049457)

        - [2. Copiar](#_Toc57049458)

        - [3. Bloc de notas](#_Toc57049459)

        - [4. Communikate](#_Toc57049460)

        - [5. Hablar](#_Toc57049461)

        - [6.Suspender](#_Toc57049462)

        - [7.Menú](#_Toc57049463)

        - [8.Cursor](#_Toc57049464)

        - [9.Lupa](#_Toc57049465)

        - [10.Acciones del cursor](#_Toc57049466)

        - [11.Selección múltiple](#_Toc57049467)

        - [12.Teclado](#_Toc57049468)

    [2. Web Browsing](#_Toc57049469)

    [3. Conversación](#_Toc57049470)

    [4. Volver a calibrar](#_Toc57049471)

    [5. Cursor](#_Toc57049472)

    - [5.1 Funciones del menú del cursor](#_Toc57049473)

        - [1. Clic izquierdo](#_Toc57049474)

        - [2. Clic derecho](#_Toc57049475)

        - [3. doble clic izquierdo](#_Toc57049476)

        - [4. Punto de fijación](#_Toc57049477)

        - [5. Clic y arrastrar](#_Toc57049478)

        - [6. Lupa](#_Toc57049479)

        - [7. Cursor magnético](#_Toc57049480)

        - [8. Volver](#_Toc57049481)

    [6. Tamaño y posición](#_Toc57049482)

    - [6.1 Funcionalidades tamaño y posición](#_Toc57049483)

        - [9. Saltar izquierda](#_Toc57049484)

        - [10. Saltar derecha](#_Toc57049485)

        - [11. Menos tenue](#_Toc57049486)

        - [12. Mas tenue](#_Toc57049487)

        - [13. Volver](#_Toc57049488)

    [7. Minimizar](#_Toc57049489)

# 
## Estado inicial del programa

Cuando la aplicación se encuentra en uso se encontrará con el siguiente icono en la parte derecha de su pantalla.

<div style={{textAlign: 'center'}}>

![screenshot](./img/manual-openeyes/0.0.png)
...
![screenshot](./img/manual-openeyes/0.1.png)
...
![screenshot](./img/manual-openeyes/0.2.png)
...
## OpenEyes – Funciones del menú principal
...
Una vez que seleccione el icono de letras con la mirada se encontrara con lo siguiente:

<div style={{textAlign: 'center'}}>

![screenshot](./img/manual-openeyes/1.jpg)
</div>

_Imagen 2: funciones generales de letras._

### 1.1 Funciones de sección letras
...
![screenshot](./img/manual-openeyes/2.png)

_Imagen 3: menú de web browsing._
</div>

### 2.1 Funciones del menú web browsing
...
![screenshot](./img/manual-openeyes/3.jpg)

_Imagen 4: teclado de conversación._

</div>

Cuenta con la mayoría de las funciones explicadas en la sección de letras. Un cambio que se debe mencionar es que aparece un botón con una nueva función, la imagen marca el botón volver (marcado como 1 en la imagen 3) que permite volver al menú principal.
...
![screenshot](./img/manual-openeyes/5.jpg)

_Imagen 5: menú del cursor._

</div>

### 5.1 Funciones del menú del cursor

#### 1. Clic izquierdo

Simula el clic izquierdo del cursor, para activar esta función debe mirar el icono, esperar a que se complete el circulo y se accione el botón, luego mirar su objetivo que desea chiclear y esperar hasta que se complete el circulo nuevamente para realizar la acción del clic izquierdo del cursor.
...
Simula el accionar de mover la pantalla (hacia arriba o hacia abajo) con la rueda del cursor, para activar debe mirar el icono hasta que se acción el botón y luego debe mirar en el lugar donde quiere activar la función (preferentemente en el centro de la pantalla), esto marcara un cuadrado en su pantalla como se muestra en la siguiente imagen.

<div style={{textAlign: 'center'}}>

![screenshot](./img/manual-openeyes/5.1.4.png)
...
![screenshot](./img/manual-openeyes/5.1.7.png)
...
![screenshot](./img/manual-openeyes/6.jpg)

_Imagen 8: menú de tamaño y posición._

</div>

### 6.1 Funcionalidades tamaño y posición
...
Cuando se activa minimizar, la aplicación vuelve a su estado de inicio, mostrando el icono que aparece al abrir el programa.