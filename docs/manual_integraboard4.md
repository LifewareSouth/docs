    ...
    - [2.4 Tableros](#24-tableros)
        - [2.4.1 Funcionalidades de los tableros](#241--funcionalidades-de-los-tableros)
            ...
            - [Crear Tableros](#2-crear-tableros)
                - [Tablero de comunicacion](#a-tablero-de-comunicacion)
...
#### 2.1.1 Como desplegar el menú y utilizar sus opciones
...
Debajo de los filtros se encuentra el listado de tableros existentes en Integraboard, y al costado derecho de esto están las acciones que pueden realizarce.
...
Observaciones para el uso de tableros de comunicación:
    ...
    -   Tiene las mismas opciones en el costado derecho que el tablero de comunicación.
...
Observación para el uso del tablero de rutinas:
    ...
    - En el costado derecho tenemos las distintas opciones, dentro de unas de las opciones está si es que el tablero de rutina es con tiempo o no. 
      ...
      para poder agregarle segundos o minutos a estos recuadros lo que debe hacer es pinchar en cada uno de los pictogramas que se seleccionaron y 
      debajo de estos se le puede escribir los minutos y/o segundos que requiera cada actividad.
...
Observación para el uso del tablero de sonido:
    ...
    - En el costado derecho están las opciones y tiene las mismas opciones que los tableros anteriormente mencionados
      (contiene, nombre, filas, columnas, etiquetas y la portada para identificar el tablero).
    - Para guardar el tablero simplemente se debe asignar una portada y luego  seleccionar el botón guardar.
...
#####   - Player con tiempo: 
    ...
    ahí comenzara el tiempo atras para realizar las actividades, una vez que se acaba el tiempo sale un mensaje de advertencia de que se acabó 
